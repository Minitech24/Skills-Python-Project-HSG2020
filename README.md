...
For our final project in the course "Skills: Programming with Advanced Computer Languages " our group create an automated data analytics programm with which a user can interact with.  
